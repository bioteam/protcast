...
class KNNClassifier:
    ...
    def __init__(
        ...
        if self.use_mlflow:
            ...
            # If a parent run is already active (e.g. comparison wrapper),
            # re-running init_mlflow() would reset client state and invalidate
            # the parent run handle. Just reuse the already-initialized module.
