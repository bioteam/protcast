...
def parse_gaf(gaf_file: Path) -> list[dict[str, dict[str,str]]]:
    """parse_gaf
    Parses a version 2.2 GO Annotation Format (GAF) file and returns a list 
    containing dicts with the 17 GAF keys. Example line:
    ...
    is missing this header as of 11/2023 so their parser no longer works. This parser 
    assumes the format is 2.2. See https://biopython.org/docs/1.75/api/Bio.UniProt.GOA.html
