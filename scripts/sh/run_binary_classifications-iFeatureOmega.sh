...
ALGORITHMS=(KNN PseKRAAC_type_16 PseKRAAC_type_15 PseKRAAC_type_14 PseKRAAC_type_13 PseKRAAC_type_12 PseKRAAC_type_11 PseKRAAC_type_10 PseKRAAC_type_9 PseKRAAC_type_8 PseKRAAC_type_7 PseKRAAC_type_6C PseKRAAC_type_6B PseKRAAC_type_6A PseKRAAC_type_5 PseKRAAC_type_4 PseKRAAC_type_3B PseKRAAC_type_3A PseKRAAC_type_2 PseKRAAC_type_1 ACC ACCC DistancePair ASDC OPF_7bit_type_3 OPF_7bit_type_2 OPF_7bit_type_1 OPF_10bit_type_1 OPF_10bit APAAC PAAC QSOrder SOCNumber KSCTriad CTriad CTDD CTDT CTDC Geary Moran NMBroto BLOSUM62 ZScale AAIndex GTPC_type_2 GTPC_type_1 GDPC_type_2 GDPC_type_1 CKSAAGP_type_2 CKSAAGP_type_1 EGAAC GAAC AESNN3 binary_3bit_type_7 binary_3bit_type_6 binary_3bit_type_5 binary_3bit_type_4 binary_3bit_type_3 binary_3bit_type_2 binary_3bit_type_1 binary_5bit_type_2 binary_5bit_type_1 binary_6bit binary TPC_type_2 TPC_type_1 DDE DPC_type_2 DPC_type_1 CKSAAP_type_2 CKSAAP_type_1 EAAC AAC)

for ALG in "${ALGORITHMS[@]}"; do
      if [ -s $DIR/${NAME}_${ALG}_summary.tsv ]; then
         continue
      fi
      python3 scripts/run_binary_classification.py -n $NAME -t test/data/uniprotkb_gpcrs.fasta -nt test/data/uniprotkb_non-gpcrs.fasta -a $ALG -f iFeatureOmega
